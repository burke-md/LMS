...
const regularProofs = {
  ...
  user3Proof: [
    "0x43c8bee048e0480d644b3fe14e67fe0bf976d6ec2c649e37c28719ce63f6a1c8",
  ],
};
const ticketProofs = {
  user4Proof: [
  ...
  user5Proof: [
    "0x95cecffd2fc1ecfcd6d165dd1f886bde991548dccdcfb8592b3fa17f776d70b9",
  ],
  user5Proof: [
...
describe("Advanced Nft", function () {
  ...
  describe("Bench mark gas", function () {
    it("Display gas estimate above", async function () {
      ...
      const gasEstimate = await nft721
        .connect(user1)
        .whiteListMintMapping(regularProofs.user1Proof, {
          value: ethers.utils.parseEther("0.05"),
        });

      console.log(
        `\t\tMerkle proof w/ mapping: ${gasEstimate.gasLimit.toString()}`
      );
    });
    ...
    it("Display gas estimate above", async function () {
      ...
      const gasEstimate = await nft721
        .connect(user4)
        .whiteListMintBitmap(ticketProofs.user4Proof, 4, {
          value: ethers.utils.parseEther("0.05"),
        });
      console.log(
        `\t\tMerkle proof w/ bitmap: ${gasEstimate.gasLimit.toString()}`
      );
    });
  });
